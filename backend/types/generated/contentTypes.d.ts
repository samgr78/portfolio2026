...
export interface ApiExperienceExperience extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Stage, alternance, job, formation...';
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<
      ['formation', 'stage', 'alternance', 'interim', 'projet_perso']
    > &
      Schema.Attribute.DefaultTo<'stage'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiProfilProfil extends Struct.SingleTypeSchema {
  ...
  info: {
    description: "Infos g\u00E9n\u00E9rales affich\u00E9es sur la page d'accueil / contact";
    displayName: 'Profil';
    pluralName: 'profils';
    singularName: 'profil';
  };
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    cvFile: Schema.Attribute.Media<'files'>;
    email: Schema.Attribute.Email;
    ...
    publishedAt: Schema.Attribute.DateTime;
    softSkills: Schema.Attribute.JSON;
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Un projet \u00E0 afficher dans le portfolio';
    displayName: 'Projet';
    pluralName: 'projects';
  ...
  attributes: {
    ...
    teamType: Schema.Attribute.String;
...
export interface ApiTechnologieTechnologie extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Une techno / langage / outil (avec logo)';
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['frontend', 'backend', 'base_de_donnees', 'outil', 'methode']
    > &
      Schema.Attribute.DefaultTo<'outil'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
